...
class Food {
  ...
  Food({this.name, this.rating, this.price, this.imageUrl, this.quantity,
    this.reference});
...
void main() {
  runApp(SampleApp(food: fetchFood(),));
}
...
//    Card makeCard(int position) => Card(
//      elevation: 8.0,
...
//    );
    ...
    // Create the body for the entire screen
